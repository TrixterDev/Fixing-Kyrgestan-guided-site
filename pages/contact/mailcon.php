...
$mail->Body    = '<h3>Имя - ' .$name . '</h3></br><hr><br><h3>Его телефон - ' .$phone. '</h3></br><hr><br><h3>Почта этого пользователя: ' .$email .'</h3></br><hr><br><h3> Вапрос - </h3><h4>' .$question1 .'</h4>';
$mail->AltBody = '';
